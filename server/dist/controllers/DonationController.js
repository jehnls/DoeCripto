...
var DonationController = /** @class */ (function () {
    ...
    DonationController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var objDonationRequest, donation, donationSave, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        objDonationRequest = req.body;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        donation = __assign({}, objDonationRequest);
                        return [4 /*yield*/, donationService.create(donation)];
                    case 2:
                        donationSave = _a.sent();
