...
var InstitutionService = /** @class */ (function () {
    ...
    InstitutionService.prototype.create = function (institutionParam) {
        return __awaiter(this, void 0, void 0, function () {
            var institutionRepository, categoryRepository, name, cnpj, site, wallet, category, findCategory, institution, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        institutionRepository = typeorm_1.getCustomRepository(InstitutionRepository_1.InstitutionRepository);
                        categoryRepository = typeorm_1.getCustomRepository(CategoryRepository_1.CategoryRepository);
                        name = institutionParam.name, cnpj = institutionParam.cnpj, site = institutionParam.site, wallet = institutionParam.wallet, category = institutionParam.category;
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, institutionRepository.save(institution)];
                    case 3:
                        _a.sent();
